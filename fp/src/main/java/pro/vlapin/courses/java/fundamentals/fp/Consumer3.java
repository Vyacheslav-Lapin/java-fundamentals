...
public interface Consumer3<T1, T2, T3> {
  ...
  default BiConsumer<T2, T3> accept(T1 t1) {
  ...
  default BiConsumer<T1, T3> accept2(T2 t2) {
    return (t1, t3) -> accept(t1, t2, t3);
  }

  default BiConsumer<T1, T2> accept3(T3 t3) {
  ...
  /**
   * Alias for {@link #accept3(T3)}
   */
  default BiConsumer<T1, T2> acceptRight(T3 t3) {
    return accept3(t3);
  }
  ...
  default BiConsumer<Tuple2<T1, T2>, T3> tupled12() {
    return (t1T2Tuple2, t3) -> accept(t1T2Tuple2._1, t1T2Tuple2._2, t3);
  }

  default BiConsumer<T1, Tuple2<T2, T3>> tupled23() {
    return (t1, t2T3Tuple2) -> accept(t1, t2T3Tuple2._1, t2T3Tuple2._2);
  }

  default BiConsumer<Tuple2<T1, T3>, T2> tupled13() {
